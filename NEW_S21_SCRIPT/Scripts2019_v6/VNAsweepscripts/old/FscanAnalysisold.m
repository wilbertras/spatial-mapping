function [arrayparam,KIDparam] = FscanAnalysisold(inputmat,fileparam)
...
filename='Chip2_nolens.dat';
dir='W:\experiments\Deshima\Deshima1\';%directory incl \ at end

%variables to find the dips (might need some playing with)
diff2treshold=0.2e8;  %Typ. 0.5-5e8. diff2treshold is treshold value in second derivation to find KIDs. 5e8 or so %
