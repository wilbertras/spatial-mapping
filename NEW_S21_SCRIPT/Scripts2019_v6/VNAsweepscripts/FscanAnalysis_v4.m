...
dir='/Volumes/KID/KIDonSun/experiments/Entropy ADR/LT102MIXED/singletone/';%directory incl \ at end

%variables for the hystograms
histdf=2;         %DEFAULT=0.5. df for Histgram plot in MHz. 0.1 for high Q>100.000
histmax=50;         %DEFAULT=20 maximum df value in the histogram (in MHz)
