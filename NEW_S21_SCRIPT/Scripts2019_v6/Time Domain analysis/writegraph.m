function writegraph(b,header,fname)
...
thisfunctionfullpath = mfilename('fullpath'); %get the full path + filename
idx=strfind(thisfunctionfullpath,'\');
fullpath=thisfunctionfullpath(1:idx(length(idx))); %truncate to full path
