...
FFT_subdir='/Noise100mK_CPW/FFT/Power';
...
OffresNoisepath = [];%Leave empty if not available
T_to_use=0.12; %in K; put in temperature you want to analyze. for only one T taken will allways work
